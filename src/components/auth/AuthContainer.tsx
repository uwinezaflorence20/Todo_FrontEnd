  ...
  return (
    <div className="auth-container font-sans">
      <div className={`auth-card ${isSignUp ? 'flipped' : ''}`}>
        ...
        {/* FRONT SIDE - Sign In */}
        <div className="auth-side auth-front">
          <div className="form-panel">
            <form action="#" className="flex h-full w-full flex-col items-center justify-center text-center" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="info-panel">
            ...
            <div className="relative z-10 p-12">
              ...
              <p className="mb-10 text-xl text-white opacity-90 leading-relaxed">Enter your personal details and start journey with us</p>
        ...
        {/* BACK SIDE - Sign Up */}
        <div className="auth-side auth-back">
          <div className="info-panel">
            <div className="geometric-bg">
              <div className="triangle triangle-1"></div>
            ...
            <div className="relative z-10 p-12">
              ...
              <p className="mb-10 text-xl text-white opacity-90 leading-relaxed">To keep connected with us please login with your personal info</p>
              <button type="button" onClick={toggleForm} className="w-56 rounded-full border-2 border-white py-4 text-lg font-bold text-white transition-all hover:bg-white hover:text-brand hover:scale-105 active:scale-95">
                SIGN IN
              </button>
            </div>
