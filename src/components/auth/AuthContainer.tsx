          ...
          <div className="overlay">
            ...
            <div className="overlay-panel overlay-left">
              ...
              <div className="relative z-10">
                ...
                <p className="mb-10 text-xl opacity-90 leading-relaxed px-12">To keep connected with us please login with your personal info</p>
            ...
            <div className="overlay-panel overlay-right">
              ...
              <div className="relative z-10">
                ...
                <p className="mb-10 text-xl opacity-90 leading-relaxed px-12">Enter your personal details and start journey with us</p>
                <button type="button" onClick={toggleForm} className="w-56 rounded-full border-2 border-white py-4 text-lg font-bold transition-all hover:bg-white hover:text-brand hover:scale-105 active:scale-95">
                  SIGN UP
                </button>
              </div>
