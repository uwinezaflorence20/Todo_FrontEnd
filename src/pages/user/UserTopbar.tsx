...
export const UserTopbar: React.FC = () => {
  ...
  const handleAddNew = () => {
    success('New Project', 'Create project modal would open here.');
  };
      ...
      <div className="flex items-center gap-10">
        ...
        <div className="flex items-center gap-4 cursor-pointer group pl-6 border-l border-gray-100">
          <div className="flex flex-col items-end">
            <p className="text-sm font-bold text-gray-800 tracking-wide">Augusta Ryan</p>
            <p className="text-[11px] font-semibold text-gray-400 capitalize">Director</p>
          </div>
